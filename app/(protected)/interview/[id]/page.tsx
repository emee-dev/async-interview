...
export default function InterviewResults({ params }: ComponentProps) {
  ...
  // In a real application, you would fetch the interview data based on the interviewId
  const interview = interviewData;

  const togglePlayPause = (recordingId: number) => {
  ...
  return (
    <div className="container mx-auto py-4 px-4 sm:px-6 lg:px-6 overflow-scroll">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-lg font-bold">{interview.candidate}</h1>
      ...
      <Tabs defaultValue="summary" className="space-y-4">
        ...
        <div className="overflow-scroll h-[500px] font-geistSans pb-4 no-srollbar">
          <TabsContent value="recordings">
            <Card>
              ...
              <CardContent>
                {interview.recordings.map((recording) => (
                  <div
                    key={recording.id}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {isPlaying && activeRecording === recording.id ? (
          ...
          <TabsContent value="summary" className="relative text-base">
            <Suspense fallback={<div>Loading...</div>}>
              <MarkdownComponent code={interview.summary} />
            </Suspense>
          </TabsContent>
        </div>
      </Tabs>
